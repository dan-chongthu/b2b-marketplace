					...
					<div class="wb-md-12">
						<div id="ams_modal_box" class="modal-content" >
							<div class="modal-header">
								<h6 class="modal-title">Wait! You are about to deactivate this plugin.</h6>
							...
							<div class="modal-body">
								...
								<form class="deactivation-survey-form" method="POST">
									<h2><?php esc_html_e( 'Please tell us why you’re deactivating the plugin. This will help us improve.', 'ams' ); ?></h2>
